...
<section id="tours" class="sec">
  ...
  <div class="tours-slider-wrap">
    ...
    <div class="tours-slider">
      <div class="inner">
        <div class="img">
          <img src="<?php echo $wp_url; ?>/lib/images/tour_sample.png" alt="">
        </div>
        <h3>ツアー名</h3>
        <p>市名</p>
      </div>
...
<section id="charm" class="sec">
  <div class="wrap">
    <h2 class="ttl2 txt-c">
      <span class="uppercase crimson">The charm</span>
      <img src="<?php echo $wp_url; ?>/lib/images/icon_charm.png" alt="tours">
    </h2>
    <p>The Yamashiro area located in the southern part of Kyoto Prefecture is naturally blessed with the soil and climate suited to tea cultivation. Tea fields were first established in the Uji area during the Kamakura period (1185–1333) when the monk Myoe introduced seeds to villagers on return from his travels in China.
      ...
      <br>
      <br>Forced to up their game, the Uji farmers responded by developing a covered growing technique for cultivating the richest, most flavorsome tencha leaves, used to grind into the vibrant green matcha powdered tea used during the tea ceremony.</p>
  </div>
  <div class="charms mt-4">
    <div class="inner">
      <a href="#">
        <h3>UJI CITY</h3>
